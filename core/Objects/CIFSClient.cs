...
namespace Core.Objects
{
    public class CIFSClient : ICIFSClient
    {
        ...
        public CIFSClient(string server, IEnumerable<Uri> uris)
        {
            ...
            _domain = Environment.GetEnvironmentVariable("SMB_DOMAIN");
            _username = Environment.GetEnvironmentVariable("SMB_USERNAME");
            _password = Environment.GetEnvironmentVariable("SMB_PASSWORD");
            Connect();
